...
export default function UserListScreen(props)
{
    ...
    const {loading:laodingDelete,error:errorDelete,success:successDelete}=userDelete;
                        ...
                        <tbody>
                            {
                                users.map(user=>(
                                    <tr key={user._id}>
                                        ...
                                        <td>
                                            <button type="button" className="small" onClick={()=>editHandler(user)}>Edit</button>
